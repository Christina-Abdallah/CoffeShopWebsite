...
export async function replyToMessage(id, reply) {
  ...
  const res = await fetch(`${ADMIN_API_URL}/messages/${id}/reply`, {
    ...fetchOptions,
    method: "POST",
    headers: {
      ...fetchOptions.headers,
...
export async function getProfile() {
  ...
  const res = await fetch(`${ADMIN_API_URL}/profile`, {
    ...fetchOptions,
    headers: {
      ...fetchOptions.headers,
      "X-CSRF-Token": csrfToken,
...
export async function addProfileEmail(email) {
  const csrfToken = await fetchCsrfToken();

  const res = await fetch(`${ADMIN_API_URL}/profile/emails`, {
    ...fetchOptions,
    method: "POST",
    headers: {
      ...fetchOptions.headers,
...
export async function deleteProfileEmail(id) {
  const csrfToken = await fetchCsrfToken();

  const res = await fetch(`${ADMIN_API_URL}/profile/emails/${id}`, {
    ...fetchOptions,
    method: "DELETE",
    headers: {
      ...fetchOptions.headers,
